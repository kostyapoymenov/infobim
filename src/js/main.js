...
//
//     function courseMore(){
//     	$(document).on('click', '.course-item__btn', function(){
//             event.preventDefault();
//
//             $('body').append("<div class='modal__overlay'></div>");
//             $('body').css("overflow", "hidden");
//
//             const inner = $(this).siblings('.modal').clone();
//
//             inner.appendTo('.modal__overlay');
//
//             $('.modal__overlay').append(inner);
//             inner.removeClass('modal-course-none');
//
//             $(document).on('click', '.modal__close', function(){
//                 event.preventDefault();
//
...
//                 inner.remove();
//                 $('body').css("overflow", "auto");
//                 $(this).parents('.modal').addClass('modal-course-none');
//             });
//         });
// 	}
//     courseMore();
...
//
// 					$(document).on('click', workIcon[z], function(e){
...
$(document).ready(function() {
    ...
    $(document).on('click', 'input[name=form-checker]', function(event){
        event.preventDefault();
    });
    ...
    $(document).on('submit', 'form', function(){
        ...
        if (!error) {
            ...
            $.ajax({
                ...
                if ($btn.hasClass('btn__access')) {
                    var template = $('#modalAccessTemplate').html();
